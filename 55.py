...
staff = ["u446015c6dce1ba353408e4f01477abc0"]
adminMID = ["u446015c6dce1ba353408e4f01477abc0"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["b","B","He","hehehe","hehe","he"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["i","I","Hm","hmmm","hmm","hm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
              ...
              if msg.from_ in admin:
                ...
                if wait["autoAdd"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦�äº†å¼€ã€‚")
            elif msg.text in ["è‡ªå‹•è¿½åŠ :ã‚ªãƒ•","Add of*f","Auto add:of*f","è‡ªå‹•è¿½åŠ ï¼šé—œ"]:
